...
parser.add_argument('-q', default=None, type=float, help="Quantile of clustered Kmers. If no value is specified all kmers will proceed to clustering. Default: None")
...
for n,a in enumerate(alignments):
    ...
    oligos.append(SeqRecord(Seq(degenseq), id=pickle_file.split(sep='_')[0]+str(n), description='', annotations={"molecule_type": "DNA"}))
